...
class WorkStation : Computer
{
    ...
    public new string GetComputerDescription()
    {
        return $"Brand: {Name}, CPU Speed: {CPU_Speed} GHz, RAM Size: {RAM} GB, Disk Size: {Disk} GB, Price: ${Price}, Monitor Brand: {MonitorBrand}, Monitor Size: {MonitorSize}\"";
    }
}
...
class mainpr
{
    static void Main(string[] args)
    {
        ...
        {
            Console.WriteLine(computer.GetComputerDescription());
        }

        Console.WriteLine("\nServers:");
        foreach (var server in servers)
        {
            Console.WriteLine(server.GetComputerDescription());
        }

        Console.WriteLine("\nWorkstations:");
        foreach (var workstation in workstations)
        {
            Console.WriteLine(workstation.GetComputerDescription());
        }
    }
}
